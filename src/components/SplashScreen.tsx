  ...
  return (
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', background:`radial-gradient(ellipse at 50% 20%, #303030 0%, #080808 65%)`, opacity:phase===2?0:1, transition:'opacity 0.5s ease' }}>
      <div style={{ transform:phase>=1?'scale(1) translateY(0)':'scale(0.5) translateY(30px)', opacity:phase>=1?1:0, transition:'all 0.7s cubic-bezier(0.34,1.56,0.64,1)', marginBottom:'24px' }}>
        <div style={{ width:'88px', height:'88px', borderRadius:'24px', background:`linear-gradient(135deg, #8b5cf6, #8b5cf6cc)`, boxShadow:`0 20px 60px #8b5cf650`, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'40px' }}>
          🔤
        </div>
      </div>
      <div style={{ opacity:phase>=1?1:0, transform:phase>=1?'translateY(0)':'translateY(12px)', transition:'all 0.5s ease 0.15s', textAlign:'center', marginBottom:'48px' }}>
        <h1 style={{ fontFamily:'Inter', fontWeight:'700', fontSize:'30px', color:'white', marginBottom:'8px' }}>FontExplorer Local</h1>
        <p style={{ color:'#8b5cf680', fontSize:'14px' }}>Find your perfect font.</p>
      </div>
      <div style={{ opacity:phase>=1?1:0, transition:'opacity 0.3s ease 0.4s', display:'flex', flexDirection:'column', gap:'10px' }}>
        <div style={{display:"flex",alignItems:"center",gap:"12px",background:"#ffffff06",border:"1px solid #ffffff10",borderRadius:"12px",padding:"10px 16px",width:"250px"}}><span style={{fontSize:"20px"}}>🔤</span><div><div style={{color:"white",fontSize:"13px",fontWeight:"500"}}>150+ fonts</div><div style={{color:"#8b5cf680",fontSize:"11px"}}>Google Fonts library</div></div></div>
<div style={{display:"flex",alignItems:"center",gap:"12px",background:"#ffffff06",border:"1px solid #ffffff10",borderRadius:"12px",padding:"10px 16px",width:"250px"}}><span style={{fontSize:"20px"}}>👁️</span><div><div style={{color:"white",fontSize:"13px",fontWeight:"500"}}>Live preview</div><div style={{color:"#8b5cf680",fontSize:"11px"}}>Type your own text</div></div></div>
<div style={{display:"flex",alignItems:"center",gap:"12px",background:"#ffffff06",border:"1px solid #ffffff10",borderRadius:"12px",padding:"10px 16px",width:"250px"}}><span style={{fontSize:"20px"}}>💾</span><div><div style={{color:"white",fontSize:"13px",fontWeight:"500"}}>Save favorites</div><div style={{color:"#8b5cf680",fontSize:"11px"}}>Your font collection</div></div></div>
      </div>
